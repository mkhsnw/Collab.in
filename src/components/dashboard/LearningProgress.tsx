          ...
          <div className="flex flex-col md:flex-row gap-4 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 w-full bg-gray-200 rounded-full h-2.5">
                <div
                  className="bg-[#504DFF] h-2.5 rounded-full"
                  style={{
        ...
        <div className="space-y-3">
          {roadmaps.slice(1, 3).map((roadmap) => (
            <div key={roadmap.id} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center mt-1">
                  <div className="w-24 bg-gray-200 rounded-full h-1.5 mr-2">
                    <div
                      className="bg-[#504DFF] h-1.5 rounded-full"
                      style={{
              ...
              <button
                className="text-[#504DFF] hover:text-[#403DC9] text-sm font-medium"
                onClick={() => {
                  navigate(
